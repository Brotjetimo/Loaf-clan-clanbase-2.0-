...
export default function AreSureAlert(props: CLicked) {
    ...
    return (
        <>
            ...
            <DialogContent sx={{ display: "flex", justifyContent: "center", color: "white", bgcolor: "rgba(0, 0, 0, 0.8)", borderLeft: "0.15vw solid black", borderRight: "0.15vw solid black" }}>
            ...
            <DialogActions sx={{ padding: "0", display: "flex", justifyContent: "center", bgcolor: "rgba(0, 0, 0, 0.8)" }}>
                <ButtonGroup variant="contained" sx={{ bgcolor: "rgba(47, 49, 55, 1)", width: "100%", border: "0.15vw solid black" }} aria-label="Basic button group">
                    ...
                    <Button variant="contained" sx={{ bgcolor: "rgba(47, 49, 55, 1)", width: "100%" }} onClick={props.Clicked}>
                        Yes
                    </Button>
                </ButtonGroup>
            </DialogActions>
